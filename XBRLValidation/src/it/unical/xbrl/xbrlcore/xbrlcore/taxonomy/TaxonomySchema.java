...
public class TaxonomySchema implements Serializable {
    ...
    /* all the elements in the taxonomy */
     ...
     * Constructor.
     *
     * @param dts DTS this taxonomy schema belongs to.
     */
     ...
     *
     * @param concept New element of the taxonomy.
     * @throws TaxonomyCreationException This exception is thrown if the ID is
     * already available.
     */
     ...
     *
     * @param id The ID for which the concept shall be obtained.
     ...
     *
     * @param name The name for which the element shall be obtained.
     * @return The according Concept object from this taxonomy. If the concept
     * is not found in this taxonomy, null is returned.
     */
    public Concept getConceptByName(String name) {
//        LogStatus.log("getConceptByName:" + name);
        Iterator iterator = concepts.iterator();
        while (iterator.hasNext()) {
            Concept tmpElement = (Concept) iterator.next();
            if (tmpElement.getName().equals(name)) {
//                LogStatus.log("getConceptByName not null");
                return tmpElement;
            }
        }
//        LogStatus.log("getConceptByName:NULL");
        return null;
    }
     ...
     * substitution group.
     *
     * @param substitutionGroup The substitution group all returned concepts
     * shall belong to.
     ...
     *
     * @param name The name of the imported taxonomy.
     */
    ...
    /**
     * @param string The name of the current taxonomy.
     */
    ...
    /**
     * @param namespace Namespace for this taxonomy schema.
     */
     ...
     * schemas.
     *
     * @param importedTaxonomySchema Schema which is checked whether it is
     * imported by this schema or one of its imported schemas.
    ...
    /**
     * @param importedTaxonomyNames The importedTaxonomyNames to set.
     */
