...
public class DLVTransform implements OntoDLVTransform {
	...
	public DLVTransform(Instance instance) {
		...
		this.companyId = ExtrasStatus.currentCompanyId;
...
//			System.out.println("context(company0, context"+entry1.getKey()+",\""+strStartDate1+"\" \""+strEndDate1+"\")");
 

//			System.out.println(">>>"+entry1.getKey()+" start1:"+strStartDate1 + " endDate1:"+strEndDate1);
			DLVContext dContext = new DLVContext();
			dContext.setCompanyId(companyId);
			dContext.setContextId(entry1.getKey());
			dContext.setDateFrom(strStartDate1);
			dContext.setDateTo(strEndDate1);
...
//		System.out.println(contextQuery);
	...
	public static String query = "%____QUERY\r\n" + 
			...
			"\r\n" + 
			"diffRate(CY, CT1,CT2, RS,V) :- checkRate(CY, CP, CP1, CT1, CT11, V1), checkRate(CY, CP, CP1, CT2, CT21, V2), rateContextRelation(CY, CT1, CT2), rateContextRelation(CY, CT11, CT21), &calculateDiffRate(V1,V2,\"0.5\";RS,V).\r\n" + 
			"\r\n" + 
			"%____end check rate\r\n" + 
			...
			"validDocument(CY) :- chooseArc(CY, CP, CP1, CT, V , CL,GR,M),&isValidatedXBRL(CY, \"0.5\";\"True\").\r\n" + 
			"nonValidDocument(CY) :- chooseArc(CY, CP, CP1, CT, V , CL,GR,M),&isValidatedXBRL(CY, \"0.5\";\"False\").\r\n" + 
			"\r\n";
