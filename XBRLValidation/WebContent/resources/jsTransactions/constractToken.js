...
contract XbrlFr is owned, token {
    ...
    function addReport(string reportId, string date) public {
        uint checkOwnReport;
        uint companyIndex;
        uint reportIndex;
    ...
    function updateValidateReport(string reportId, string validated) public {
        uint checkOwnReport;
        uint companyIndex;
        uint reportIndex;
        (checkOwnReport,companyIndex, reportIndex )= ownReport(reportId);
    ...
    function addFact(string reportId, string concept, string context, string value, string unit, string factgroup) public {
    	uint checkOwnReport;
        uint companyIndex;
        uint reportIndex;
        (checkOwnReport,companyIndex, reportIndex )= ownReport(reportId);
        ...
        uint factIndex = companies[companyIndex].reports[reportIndex].facts.length;
        companies[companyIndex].reports[reportIndex].facts.length += 1;
        companies[companyIndex].reports[reportIndex].facts[factIndex].concept = concept;
        companies[companyIndex].reports[reportIndex].facts[factIndex].context = context;
        companies[companyIndex].reports[reportIndex].facts[factIndex].value = value;
        companies[companyIndex].reports[reportIndex].facts[factIndex].unit = unit;
        companies[companyIndex].reports[reportIndex].facts[factIndex].factgroup = factgroup;
    }
    
    function addArc(string reportId, string conceptFrom, string conceptTo, string weight, string calLinkBase) public {
    	uint checkOwnReport;
        uint companyIndex;
        uint reportIndex;
        (checkOwnReport,companyIndex, reportIndex )= ownReport(reportId);
        ...
        uint arcIndex = companies[companyIndex].reports[reportIndex].arcs.length;
        companies[companyIndex].reports[reportIndex].arcs.length += 1;
        companies[companyIndex].reports[reportIndex].arcs[arcIndex].conceptFrom = conceptFrom;
        companies[companyIndex].reports[reportIndex].arcs[arcIndex].conceptTo = conceptTo;
        companies[companyIndex].reports[reportIndex].arcs[arcIndex].weight = weight;
        companies[companyIndex].reports[reportIndex].arcs[arcIndex].calLinkBase = calLinkBase;
    }
   
    function getReportByIndex(uint companyIndex, uint reportIndex) 
    	public constant returns (string rpId, uint rpIndex, string date, string validated, uint factSize, uint arcSize) {
		...
		return (companies[companyIndex].reports[reportIndex].reportId, 
				...
				companies[companyIndex].reports[reportIndex].facts.length, 
				companies[companyIndex].reports[reportIndex].arcs.length);
    }
    
    function getFactByIndex(uint companyIndex, uint reportIndex, uint factIndex) 
    	public constant returns(string concept, string context, string value, string unit, string factgroup) {
    	
    	return (companies[companyIndex].reports[reportIndex].facts[factIndex].concept,
    			companies[companyIndex].reports[reportIndex].facts[factIndex].context,
    			companies[companyIndex].reports[reportIndex].facts[factIndex].value,
    			companies[companyIndex].reports[reportIndex].facts[factIndex].unit,
    			companies[companyIndex].reports[reportIndex].facts[factIndex].factgroup);
    }
    
    function getArcByIndex(uint companyIndex, uint reportIndex, uint arcIndex) 
		public constant returns(string conceptFrom, string conceptTo, string weight, string calLinkBase) {
	
		return (companies[companyIndex].reports[reportIndex].arcs[arcIndex].conceptFrom,
				companies[companyIndex].reports[reportIndex].arcs[arcIndex].conceptTo,
				companies[companyIndex].reports[reportIndex].arcs[arcIndex].weight,
				companies[companyIndex].reports[reportIndex].arcs[arcIndex].calLinkBase);
    }
    
    function updateFactByIndex(uint companyIndex, uint reportIndex, uint factIndex,
    		string concept, string context, string value, string unit, string factgroup) public {
    ...
    function updateArcByIndex(uint companyIndex, uint reportIndex, uint arcIndex,
    		string conceptFrom, string conceptTo, string weight, string calLinkBase) public {
