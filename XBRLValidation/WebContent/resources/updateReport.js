    ...
    function getReportsHTML(){
    	...
    	for (var i = 0;i < reportSize;i++) {
    		getReportByIndex(i, function(rindex,result){
    			//console.log(result);
    			factSize =  new web3.BigNumber(result[4]).toString();
    			arcSize =  new web3.BigNumber(result[5]).toString();
    			...
    			$(".lsReports").append(
    					...
    					"<td>"+factSize+"</td>" +
    					"<td>"+result[3]+"</td>"+
    					"<td><div class='readReportBtn "+factSize+" "+arcSize+" "+reportIndex+" "+result[3]+" "+result[0]+"'>Read Report</div></td></tr>");
    		})
    	}
    }
...
//    			console.log(result);
    			...
    			"    <td>\r\n" + 
    			"        <div class='updateFactBtn "+findex+" "+reportIndex+" "+facts.length+"'>Update</div>\r\n" + 
    			"    </td>\r\n" + 
    			"</tr>"
    			$(".lsFacts").append(htmlText);
    			//fact (itcc_ci_TotaleCreditiVersoSociVersamentiAncoraDovuti,contextiEsC,"15000",euro,fgroupGlobal).
    			facts.push("fact (company,"+result[0]+","+result[1]+",\""+result[2]+"\","+result[3]+","+result[4]+").");
    		})
    	}
    }
...
//    			console.log(result);
    			...
    			"    <td>\r\n" + 
    			"        <div class='updateArcBtn "+aindex+" "+reportIndex+" "+arcs.length+"'>Update</div>\r\n" + 
    			"    </td>\r\n" + 
    			"</tr>"
    			$(".lsArcs").append(htmlText);
    			//arc (from,to,"1.0",http_www_infocamere_it_itnn_fr_itcc_role_CEAbbreviata).
    			arcs.push("arc (company,"+result[0]+","+result[1]+",\""+result[2]+"\","+result[3]+").");
    		})
    	}
    }
    ...
    $('body').on('click', '.updateFactBtn', function() {
    	...
    	htmlFindex = $(this).attr("class").split(" ")[3];
//    	console.log(findex);
//    	console.log(reportIndex);
    	...
    	facts[htmlFindex] = "fact (company, "+concept+","+context+",\""+value+"\","+unit+","+factgroup+").";
...
//    	console.log(facts);
    ...
    $('body').on('click', '.updateArcBtn', function() {
    	...
    	reportIndex = $(this).attr("class").split(" ")[2];
    	htmlAindex = $(this).attr("class").split(" ")[3];
    	...
    	arcs[htmlAindex] = "arc (company, "+conceptFrom+","+conceptTo+",\""+weight+"\","+calLinkBase+").";
